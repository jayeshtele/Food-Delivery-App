    ...
    <>
      <header className="sticky top-0 z-40 border-b border-white/10 bg-ink/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center rounded-full border border-white/10 bg-white/[0.04] p-1">
      ...
      <nav className="fixed bottom-0 z-50 flex justify-between w-full items-center border rounded-full border-white/10 bg-ink/90 p-3 md:hidden">
        <NavLink to="/" className={linkClass}>
          Home
        </NavLink>
        <NavLink to="/menu" className={linkClass}>
